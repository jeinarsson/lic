...
We consider the viscous Stokes regime, where the particle Reynolds number $\rep\ll1$ ($\rep = u_0 a/\nu$, where $u_0$ is a typical flow speed, $a$ is the particle size and $\nu$ is the kinematic viscosity of the fluid). In this \emph{advective regime}, the hydrodynamic torques are given by Jeffery's theory [\textsc{Jeffery, G. B.} \emph{Proc. R. Soc. Lond. A} \textbf{102}, 161–179 (1922)].
