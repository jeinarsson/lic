...
\rfoot[]{%
  ...
  \begin{picture}(0,0)%
    \put(0.4,-2){%
      \fbImageF{./figs/plotting/flipbook/output/symm/}{png}{scale=0.75}%
    }%
  \end{picture}%
}
\lfoot[%
  ...
  \begin{picture}(0,0)
    \put(-3.3,-2){
      \fbImageF{./figs/plotting/flipbook/output/triax/}{png}{scale=0.75}
    }
  \end{picture}
]{}
}
...
Last but not least, I thank the people who read this thesis and gave me helpful comments and suggestions: Kajsa, Rasmus, Tora, Bernhard, Erik, Kristian, Marina.
}
%\paperwork{Text}
...
{\sc Einarsson, J., Angilella, J.~R. \& Mehlig, B.} 2013{\natexlab{{\em b\/}}}
  ...
  viscous flows. Submitted to Physica D July 10, 2013, available as {arXiv} e-print 1307.2821.%
}
...
{\sc Gustavsson, K., Einarsson, J. \& Mehlig, B.} 2013 Tumbling of small
  axisymmetric particles in random and turbulent flows. In review Physical Review Letters, available as {arXiv} e-print
  1305.1822.%
}
...
%\publication{A microfluidic device for studies of the orientational dynamics of microrods}{%
%{\sc Mishra, Y.~N., Einarsson, J., John, O.~A., Andersson, P., Mehlig, B. \&
%  Hanstorp, D.} 2012 A microfluidic device for studies of the orientational
%  dynamics of microrods. , vol. 8251, pp. 825109--825109--11.%
%}
\end{document}
