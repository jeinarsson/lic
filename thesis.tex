...
\dedication{\textit{to the people around me.}}
\paperwork{Text}
...
\paper{A study of multiple crack interaction at rolling contact fatigue of rails}{Text}
%\paper{Aperiodic tumbling of microrods advected in a microchannel flow}{Text}
%\includepdf[pages=-,width=\paperwidth]{ExampleMasters.pdf} % You could use subfiles here instead.
\paper{Tumbling of small axisymmetric particles in random and turbulent flows}{Text}
