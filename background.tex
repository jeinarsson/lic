...
\end{align}
The vector $\ve \Omega$, defined as half the vorticity, is a common quantitiy in our calculations, and therefore is given its own symbol. The elements of $\ma O$ are related to $\ve \Omega$ by $O_{ij} = -\lc_{ijp}\Omega_p$. In this thesis $\lc$ denotes the anti-symmetric third order tensor
\begin{align*}
\lc_{ijk} = \begin{cases}
