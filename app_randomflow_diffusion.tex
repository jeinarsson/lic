...
\end{align}
Inserting \Eqnref{fjeffery} in \Eqnref{deltan}, and taking averages leads to the Fokker-Planck equation coefficients
%\footnote{In vector notation $(\ve a^{(1)})_i = a^{(1)}_i$ and $(\ma A^{(2)})_i = a^{(2)}_{ij}$}
\begin{align*}
